        ...
        <div class="table-wrapper">
          <table>
            ...
            <tbody>
              ${expenses.map(ex => `
                <tr>
                  <td data-label="Category"><span class="badge badge-info">${escapeHtml(ex.category)}</span></td>
                  <td data-label="Description">${escapeHtml(ex.description || '—')}</td>
                  <td data-label="Amount" class="font-bold text-danger">${formatCurrency(ex.amount)}</td>
                  <td data-label="Date" class="text-muted text-sm">${formatDateTime(ex.date)}</td>
