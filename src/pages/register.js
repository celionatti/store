...
export function renderRegister(container) {
    ...
    <div style="max-width: 450px; width: 100%; padding: var(--space-xl);" class="card">
      ...
      <form id="register-form">
        ...
        <div class="form-group" style="margin-bottom: var(--space-lg);">
          ...
          <div id="admin-warning" style="display: none; margin-top: 8px; font-size: 0.8rem; color: #e11d48; padding: 8px; background: #fff1f2; border-radius: 4px; border: 1px solid #fda4af;">
            Note: Admin registration is restricted if an administrator already exists.
          </div>
        </div>
  ...
  roleSelect?.addEventListener('change', () => {
    if (adminWarning) {
      adminWarning.style.display = roleSelect.value === 'admin' ? 'block' : 'none';
    }
  });
