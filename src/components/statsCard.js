...
export function createStatsCard(label, value, iconType = 'brand', iconSvg = '', subtitle = '') {
  const defaultIcons = {
    ...
    info: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>',
  };

  const svg = iconSvg || defaultIcons[iconType] || defaultIcons.brand;
