...
const BOTTOM_NAV_ITEMS = [
  { label: 'Home', href: '#/', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>' },
